<template>
    <div class="content-container">
        <div class="intro-section">
            <h1>Welcome to Foopy.</h1><br>
            <svg viewBox="0 0 3000 3000" class="foopy-icon">
        ...
        <hr class="section-divider"> <!-- Divider Line -->
  
        <!-- Image Carousel heading -->
        <h2 class="carousel-heading">Discover What Our Store Has to Offer</h2>
